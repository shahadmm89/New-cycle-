...
export const scenes: SceneConfig[] = [
  ...
  },
  {
    ...
    beats: {
      ...
      kpi3: 13.6,
      kpiCombine: 14.4,
      // Bottom-timeline pins, on the word: "...around November" / "...by December".
      timelineNov: 9.9,
      timelineDec: 18.2,
    },
    voice: [
  ...
  },
  {
    ...
    beats: {
      ...
      line2: 8.6,
      alignIn: 12.6,
      // Bottom-timeline pins, on the word: "By January..." / "by February...".
      timelineJan: 4.8,
      timelineFeb: 9.5,
      timelineOut: 18.2,
    },
  ...
  },
  {
    ...
    voice: [
      ...
      },
      {
        id: 's9-l2',
        start: 3.4,
        text: 'During the implementation year only, the merit calculation covers 15 months instead of 12.',
        spoken:
          'During the implementation year only, the merit calculation covers fifteen months instead of twelve.',
        rate: 1.0,
      ...
      },
      {
        id: 's9-l4',
        start: 14.6,
        text: "that's 5% divided by 12, which is about 0.417% a month.",
        spoken:
          "that's five percent divided by twelve, which is about zero point four one seven percent a month.",
        rate: 1.0,
